 ...
 * Triggered via notifyDemoBackendAction() in lib/demo.ts. Mirrors the
 * storefront's components/DemoNotice.tsx.
 */
const DemoNotice: React.FC = () => {
    ...
    return (
        <div
            role="status"
            className="fixed bottom-20 left-1/2 -translate-x-1/2 z-50 flex items-center gap-3 max-w-[92vw] bg-slate-900 text-white text-sm font-medium px-4 py-2.5 rounded-xl shadow-lg"
        >
